function res = ineuron_737_290124_struct()
    res = struct();
    res.name = 'ineuron_737_290124_struct';
    ...
    res.cat_cols = [0 0 0];
    res.proc_dir = '../analysis_data/analysis/290124_ineurons_737/data_struct';
    res.traj_type = 'track';
    ...
    res.spots_handler = TrackmateSpotsParser(res.base_dir, 'trackmate/spots_mask=1_rad=1.5_th=0.2.csv', {'th'});
