function res = simu_dens_ER_BSA_009_time_track_struct_6(base_dir, reps)
    res = struct();
    res.name = 'simu_ER_BSA_009_track_struct_6_v3';
    ...
    res.track_handler = TrackmateFileParser(res.base_dir, res.data, 'tracks_struct_6.1_v3', 1, [1 5 3 4]); %add column 7
end