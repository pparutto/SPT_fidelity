function res = simu_dens_lines_31_time5(base_dir, reps)
    res = struct();
    res.name = 'simu_lines_31_5';
    ...
    res.spots_handler = SimuSpotsParser(res.base_dir, 'trajs_cliped_recent.csv', {}, 0.01);
