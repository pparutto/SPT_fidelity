function res = simu_dens_mito_Tom20mNeonGreen9_time10(base_dir, reps)
    res = struct();
    res.name = 'simu_mito_Tom20mNeonGreen9_10';
    ...
    res.proc_dir = '../analysis_simu/analysis/simu/mito/C2-210505_COS7_TOMM20-Halo-PAJF646_Mito-mNeonGreen_9.czi';
    res.traj_type = 'simu';
    res.params = {};
