function res = mito_210311_struct_first()
    res = struct();
    res.name = 'mito_210311_struct_first';
    res.pxsize = 0.0967821;
    res.base_dir = '../analysis_data/tracking/Mito/210311_firststruct';
    res.data = {'C1-210311_COS67_TOM20-Halo_Mito-mNeonG_untreated_3.czi.tif'};

    res.cat_idxs = [1];
    res.cat_names = {'TOMM'};
    res.cat_cols = [1 0 1];
    res.proc_dir = '../analysis_data/analysis/Mito/210311_firststruct';
    res.traj_type = 'track';
