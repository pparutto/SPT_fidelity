function res = simu_dens_ER_BSA_004_time13(base_dir, reps)
    res = struct();
    res.name = 'simu_ER_BSA_004_13';
    ...
    res.proc_dir = '../analysis_simu/analysis/simu/ER/C2-Sec61b_Halo-paJF646+400uMBSA_004.czi';
    res.traj_type = 'simu';
    res.params = {};
