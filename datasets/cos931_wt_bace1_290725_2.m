function res = cos931_wt_bace1_290725_2()
    res = struct();
    res.name = 'cos931_wt_bace1_290725';
    res.pxsize = 0.065;
    res.data_dir = '';
    ...
    res.data = {'well1_bace1_snapkdel/cell10_nobace1_10ms/C3-cell10_nobace1_10ms_MMStack_Pos0.ome.tif';
                ...
                'well1_bace1_snapkdel/cell7_nobace1_1/C3-cell7_nobace1_1_10ms_MMStack_Pos0.ome.tif';
                'well1_bace1_snapkdel/C3-cell6_nobace1_10ms_MMStack_Pos0.ome.tif';
                'well1_bace1_snapkdel/C3-cell7_nobace1_10ms_MMStack_Pos0.ome.tif';
                'well1_bace1_snapkdel/C3-cell8_nobace1_1_10ms_MMStack_Pos0.ome.tif';
                'well1_bace1_snapkdel/C3-cell9_nobace1_1_10ms_MMStack_Pos0.ome.tif';
                'well1_bace1_snapkdel/C3-cell9_nobace1_10ms_MMStack_Pos0.ome.tif'};


    res.cat_idxs = [1 2 1 1];
    res.cat_names = {'WT'; 'BACE1OE'};

    res.cat_cols = [1 0 0; 1 0.4 0 ; 0 0 1; 0.2 0.8 1; 0 0 0; 0.2 0.9 0; 1 0 1];
    res.proc_dir = '../analysis_data/analysis/APP/290725_PP_YY_cos123-931';
    res.traj_type = 'track';
