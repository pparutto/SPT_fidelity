function res = simu_dens_lines_31_time11(base_dir, reps)
    res = struct();
    res.name = 'simu_lines_31_11';
    ...
    res.proc_dir = '../analysis_simu/analysis/simu/lines/struct_line_dist=31_pxsize=0.024195525_poly';
    res.traj_type = 'simu';
    res.params = {};

    res.constr = struct();

    res.spots_handler = SimuSpotsParser(res.base_dir, 'trajs_cliped_recent.csv', {}, 0.5625);
    res.track_handler = SimuFileParser(res.base_dir, res.data, 1, 'trajs_cliped_recent.csv');
end