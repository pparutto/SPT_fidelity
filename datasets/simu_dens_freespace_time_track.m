function res = simu_dens_freespace_time_track(base_dir, reps, trck_ps)
    res = struct();
    res.trck_prefix = trck_ps.prefix;
    res.name = sprintf('simu_freespace_time_%s', trck_ps.prefix);
    ...
    res.track_handler.ignore = {'struct', '_fn_',  '_nn_'};
end