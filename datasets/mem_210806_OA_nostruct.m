function res = mem_210806_OA_nostruct()
    res = struct();
    res.name = 'mem_210806_OA';
    res.pxsize = 0.0967821;
    res.base_dir = '../analysis_data/tracking/Mem/210806_OA_nostruct';
    ...
    res.proc_dir = '../analysis_data/analysis/Mem/210806_OA_nostruct';
    res.traj_type = 'track';
    ...
    res.track_handler = TrackmateFileParser(res.base_dir, res.data, 'tracks_', 1, [1 5 3 4 6 7]);
end