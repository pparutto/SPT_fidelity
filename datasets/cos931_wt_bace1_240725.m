function res = cos931_wt_bace1_240725()
    res = struct();
    res.name = 'cos931_wt_bace1_240725';
    res.pxsize = 0.065;
    res.data_dir = '';
    res.base_dir = '../analysis_data/tracking/APP/240725';
    res.data = {'C3-cell20_good_MMStack_Pos0.ome.tif'};

    res.cat_idxs = [1];
    res.cat_names = {'WT'; 'BACE1OE'};

    res.cat_cols = [1 0 0; 1 0.4 0 ; 0 0 1; 0.2 0.8 1; 0 0 0; 0.2 0.9 0; 1 0 1];
    res.proc_dir = '../analysis_data/analysis/APP/240725';
    res.traj_type = 'track';
