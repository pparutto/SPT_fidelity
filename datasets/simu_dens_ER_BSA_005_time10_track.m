function res = simu_dens_ER_BSA_005_time10_track(base_dir, reps)
    res = struct();
    res.name = 'simu_ER_BSA_005_10_track';
    ...
    res.proc_dir = '../analysis_simu/analysis/simu/ER/C2-Sec61b_Halo-paJF646+400uMBSA_005.czi_track';
    res.traj_type = 'track';
