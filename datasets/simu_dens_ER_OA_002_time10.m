function res = simu_dens_ER_OA_002_time10(base_dir, reps)
    res = struct();
    res.name = 'simu_ER_OA_002_10';
    ...
    res.proc_dir = '../analysis_simu/analysis/simu/ER/C2-Sec61b_Halo-paJF646+400uMOA_002.czi';
    res.traj_type = 'simu';
    res.params = {};
