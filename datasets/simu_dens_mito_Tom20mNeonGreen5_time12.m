function res = simu_dens_mito_Tom20mNeonGreen5_time12(base_dir, reps)
    res = struct();
    res.name = 'simu_mito_Tom20mNeonGreen5_12';
    ...
    res.proc_dir = '../analysis_simu/analysis/simu/mito/C2-210505_COS7_TOMM20-Halo-PAJF646_Mito-mNeonGreen_5.czi';
    res.traj_type = 'simu';
    res.params = {};
