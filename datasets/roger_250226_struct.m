function res = roger_250226_struct()
    res = struct();
    res.name = 'roger_250226_struct';
    res.pxsize = 0.159;
    ...
    res.cat_cols = [0 0 0];
    res.proc_dir = '../analysis_data/analysis/ERES/roger/Hela_250226_struct';
    res.traj_type = 'track';
    ...
    res.track_handler.ambig_col = 10;
end