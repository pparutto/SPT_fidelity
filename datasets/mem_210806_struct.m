function res = mem_210806_struct()
    res = struct();
    res.name = 'mem_210806_struct';
    res.pxsize = 0.0967821;
    res.base_dir = '../analysis_data/tracking/Mem/210806_v3_wdur=11';
    res.data = {'C1-210806_COS7_mEM-KDEL_Sec61-Halo-PA646_BSA_004.czi.tif'};

    res.cat_idxs = [1];
    res.cat_names = {'UNT'};
    res.cat_cols = [0 0 0];
    res.proc_dir = '../analysis_data/analysis/Mem/210806_struct_v3_wdur=11';
    res.traj_type = 'track';
