function res = cos931_wt_bace1_240925()
    res = struct();
    res.name = 'cos931_wt_bace1_240925';
    res.pxsize = 0.0645;
    res.data_dir = '';
    res.base_dir = '../analysis_data/tracking/APP/240925';
    res.data = {'cell10_nobace1/C3-cell10_nobace1_MMStack_Pos0.ome.tif/';
                'cell9_nobace1/C3-cell9_nobace1_MMStack_Pos0.ome.tif/'};

    res.cat_idxs = [1 1];
    res.cat_names = {'WT'; 'BACE1OE'};

    res.cat_cols = [1 0 0; 1 0.4 0 ; 0 0 1; 0.2 0.8 1; 0 0 0; 0.2 0.9 0; 1 0 1];
    res.proc_dir = '../analysis_data/analysis/APP/240925';
    res.traj_type = 'track';
