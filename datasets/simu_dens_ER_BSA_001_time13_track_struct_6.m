function res = simu_dens_ER_BSA_001_time13_track_struct_6(base_dir, reps)
    res = struct();
    res.name = 'simu_ER_BSA_001_13_track_struct_6_v3';
    ...
    res.proc_dir = '../analysis_simu/analysis/simu/ER/C2-Sec61b_Halo-paJF646+400uMBSA_001.czi_track_struct_6_v3';
    res.traj_type = 'track';
    ...
    res.track_handler = TrackmateFileParser(res.base_dir, res.data, 'tracks_struct_6.1_v3', 1, [1 5 3 4 7]);
end