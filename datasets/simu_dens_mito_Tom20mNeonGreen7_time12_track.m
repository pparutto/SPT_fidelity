function res = simu_dens_mito_Tom20mNeonGreen7_time12_track(base_dir, reps)
    res = struct();
    res.name = 'simu_mito_Tom20mNeonGreen7_12_track';
    ...
    res.proc_dir = '../analysis_simu/analysis/simu/mito/C2-210505_COS7_TOMM20-Halo-PAJF646_Mito-mNeonGreen_7.czi_track';
    res.traj_type = 'track';
