function res = simu_dens_mito_Tom20mNeonGreen5_time10_track_struct_6(base_dir, reps)
    res = struct();
    res.name = 'simu_mito_Tom20mNeonGreen5_10_track_struct_6_v3';
    res.base_dir = sprintf('%s/C2-210505_COS7_TOMM20-Halo-PAJF646_Mito-mNeonGreen_5.czi', base_dir);
    ...
    res.proc_dir = '../analysis_simu/analysis/simu/mito/C2-210505_COS7_TOMM20-Halo-PAJF646_Mito-mNeonGreen_5.czi_track_struct_6_v3';
    res.traj_type = 'track';
